...
public class ArchivoUtil {
	...
	public static void moveFile(String sourcePath, String destinationPath) throws IOException {
       ...
       // String destinationPath="E:\\destination location\\";  // destination file path
        ...
        File destinationFile = new File(destinationPath, sourceFile.getName()+cargarFechaSistema());   //Creating A Destination File. Name stays the same this way, referring to getName()
        try 
        {
...
//	public static void moveFile(String sourcePath, String destinationPath) throws IOException {
//		for (int i = 1; i <= 3; i++) {
//	        String copia = destinationPath + sourcePath.getName()+cargarFechaSistema() + ".txt";
//	        BufferedReader l = new BufferedReader(new FileReader(sourcePath));
//	        BufferedWriter e = new BufferedWriter(new FileWriter(copia));
//	        
//	        String linea;
 ...
 */
	...
	public static String cargarFechaSistema() {
		...
		//		fecha_Actual+= ano+"-"+mesN+"-"+ diaN;
		//		fechaSistema = ano+"-"+mesN+"-"+diaN+"-"+hora+"-"+minuto;
		return fechaSistema = ano+"-"+mesN+"-"+diaN;
